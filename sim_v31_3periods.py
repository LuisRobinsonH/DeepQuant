#!/usr/bin/env python
"""
DeepQuant V31 — Open/Close only + Intraday Alert Alignment (V29 base)
=======================================================================
V31 CHANGES vs V30:
...
# === HEADER ===
print("=" * 80)
print("  DEEPQUANT V31 — Open/Close only | Intraday alerts aligned (V29 base)")
...
if __name__ == "__main__":
    ...
    #  Per-period summary 
    print(f"\n\n{'='*80}")
    print(f"  SUMMARY - DEEPQUANT V31 (Open/Close only | Intraday alignment | MODERATE disabled)")
    print(f"{'='*80}")
    ...
    print(f"  V30   -16.85%  +30.56%   -0.50%   +8.02%      $0   $-281 $-1,067 $+2,445    $-40  2/5 rs_vas+EMA5+ATR")
    print(f"  V31  {p1['roi']:>+7.2f}% {p2['roi']:>+7.2f}% {p3['roi']:>+7.2f}% {cum_roi:>+7.2f}% {yr_all['2022']:>7s} {yr_all['2023']:>7s} {yr_all['2024']:>7s} {yr_all['2025']:>7s} {yr_all['2026']:>7s}  {passed}/{passed+failed} O/C+Open")
    print(f"{'='*90}")
    print(f"\n  Time: {elapsed:.1f} min")
