#!/usr/bin/env python
"""
DeepQuant V32 — Walk-Forward desde 2010 (17 años anuales)
==========================================================
V32 CHANGES vs V31:
...
if __name__ == "__main__":
    ...
    #  Per-period summary
    print(f"\n\n{'='*90}")
    print(f"  SUMMARY - DEEPQUANT V32 | Walk-Forward 2010-2026 | 17 Annual Periods")
    print(f"{'='*90}")
    ...
    print(f"")
    print(f"  V32 (this run): 17-year walk-forward 2010-2026")
    ...
    try:
        ...
        plt.tight_layout()
        plt.savefig("v32_annual_roi.png")
        plt.close()
        ...
        plt.ylabel("Capital ($)")
        plt.tight_layout()
        plt.savefig("v32_equity_compound.png")
        plt.close()
        ...
        if all_trade_list:
            ...
            plt.tight_layout()
            plt.savefig("v32_trades_per_year.png")
            plt.close()

        print("  Graficos guardados: v32_annual_roi.png  v32_equity_compound.png  v32_trades_per_year.png")
    except Exception as e:
        print(f"  Warning graficos: {e}")

    #  Export to Excel
    fname = f"sim_v32_{now}.xlsx"
    try:
